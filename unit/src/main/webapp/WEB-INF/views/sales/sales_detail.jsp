...
<body>
	...
	<div class="container panel panel-info">
		<h3 class="panel-heading">재능 판매 상세페이지</h3>
		<form action="${pageContext.request.contextPath}/talentSales/readOne" method="post" id="join_form" enctype="multipart/form-data">
			<fieldset>
				<legend>재능 판매 글 등록</legend>
				
				<div class="from-group">
				<div><img  src="${pageContext.request.contextPath}/resources/upload/${dto.salesImg}" alt="판매글상세이미지"/></div>
				<input type="hidden"	name="pre_file"  class="form-control" 	value="${dto.getSalesImg()}" readonly/>
				</div>
				
				<div class="from-group">
					<label for="salesTitle">제목</label> 
					<input type="text" name="salesTitle" id="salesTitle" class="form-control" value = "${dto.getSalesTitle()}" readonly />
				</div>
				...
				<div class="from-group">
					...
					<textarea name="salesInfo" id="salesInfo" class="form-control" rows="10" readonly>${dto.getSalesInfo()}</textarea>
				</div>
				
				<div class="from-group">
					<label for="salesCurriculum">서비스 절차</label> 
					<textarea name="salesCurriculum" id="salesCurriculum" class="form-control" rows="10"  readonly>${dto.getSalesCurriculum()}</textarea>
				</div>
				...
				<div class="from-group">
					...
					<input type="number" name="salesPrice" id="salesPrice" class="form-control" placeholder="가격을 입력해주세요" value = "${dto.getSalesPrice()}" readonly />
					
				</div>
				
				<div class="from-group">
					<input type="text" name="userNum" id="userNum" value = "${dto.getUserNum()}" readonly/>
					<input type="text" name="salesNum" id="salesNum" value = "${dto.getSalesNum()}" readonly/>
				</div>
				
				<div class="form-group">
					<input type="submit" value="결제하기" class="btn btn-danger form-control">
				</div>
				<div class="form-group">
